...
<body>
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="page-header">
            <h4><em>Create, edit or delete a template..</em></h4>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div style="text-align:center" class="col-md-4">
                <a href="#">
                <img data-src="holder.js/200x200" src="editicon.png" class="img-thumbnail" alt="Edit Template">
                <h3> Edit Template </h3>
                </a>
            </div>
            <div style="text-align:center" class="col-md-4">
                <a href="#">
                <img data-src="holder.js/200x200" src="deleteico.png" class="img-thumbnail" alt="Delete Template">
